...
function Question() {
  ...
  // Show loading or error if data is not ready or invalid
  if (!questionData || questionData.length === 0) {
    return (
      <p className="text-center mt-10 text-lg font-semibold text-red-600">
        Loading or failed to load questions...
      </p>
    );
  }
  ...
  return (
    <AnimateProvider className="max-w-xl mx-auto">
      ...
      <button
        disabled={!questionData || questionData.length === 0}
